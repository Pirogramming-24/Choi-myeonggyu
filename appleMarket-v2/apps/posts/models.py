...
class Post(models.Model):
    ...
    # --- 영양 성분 필드 추가 ---
    calories = models.FloatField('칼로리(Kcal)', default=0.0)
    carbs = models.FloatField('탄수화물(g)', default=0.0)
    protein = models.FloatField('단백질(g)', default=0.0)
    fat = models.FloatField('지방(g)', default=0.0)
    # -----------------------
